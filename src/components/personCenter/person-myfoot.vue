<template>
    <div>
        <p class="person-title padding-b-10">
            <span class="padding-10 title-con" style="border-bottom:1px solid #D61B52;">我的足迹</span>
        </p>
        <ul v-infinite-scroll  class="listshop-list text-c clearfix"  style="height:500px;overflow:auto">
            <li class="listshop-lists">
                ...
                <router-link  to='/detail'><p class="listshop-btn list-detail">查看详情</p></router-link>
                <p title="移出收藏夹" class=" el-icon-delete  shoucang "></p>
