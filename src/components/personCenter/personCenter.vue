    ...
    <div class="longran-Person">
        ...
        <div class="clearfix padding-30">
            <ul class="person-list fl clearfix">
                ...
                <router-link to="/personCenter/personcollect">  <li class="person-lists">我的收藏夹</li></router-link>
